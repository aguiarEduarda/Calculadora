            ...
            <div class="row">
                <form method="POST" action="{{ route('subtrair') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input style="background-color: rgb(207, 235, 225)" type="number" class="form-control" id="primeiroValor" name="valor1">
                    </div>
                    <div class="mb-3">
                        <label for="segundoValor" class="form-label">Segundo valor</label>
                        <input style="background-color: rgb(207, 235, 225)" type="number" class="form-control" id="segundoValor" name="valor2">
                      </div>                   
